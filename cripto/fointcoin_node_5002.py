...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = "Kaltenbruner", amount = 10)
...
def connect_node():
    ...
    response = {'message' : 'Todos los nodos han sido conectados. La cadena de FointCoins contiene ahora los nodos siguientes: ',
